"""Base class for building custom Cohestra autoscalers."""
...
from cohestra_sdk.client import CohestraClient, Deployment

logger = logging.getLogger("cohestra.autoscaler")
