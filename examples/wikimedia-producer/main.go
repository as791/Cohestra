...
// exercising the Cohestra sample job end-to-end.
package main
...
func main() {
	...
	userAgent := env("USER_AGENT", "cohestra-wikimedia-producer/1.0 (https://github.com/as791/Flink-Actor-Control-Plane)")
