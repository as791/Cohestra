...
/**
 * Sample Flink 2.2 streaming job for the Cohestra control-plane demo.
 *
 ...
 *   <li>{@code --group.id} consumer group (default cohestra-wiki-edit-count)</li>
 * </ul>
 */
public final class WikiEditCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String brokers = params.getOrDefault("bootstrap.servers", "cohestra-kafka-bootstrap.kafka.svc:9092");
        final String sourceTopic = params.getOrDefault("source.topic", "wikimedia.recentchange");
        final String groupId = params.getOrDefault("group.id", "cohestra-wiki-edit-count");
        ...
        env.execute("cohestra-wiki-edit-count");
    }
